...
\shorttitle{Convective Boundary Processes}
...
%%%% Title and Abstract
\title{Convective Boundary Mixing Processes}
...
\begin{abstract}
    ...
    We describe the structure of a convective boundary that these processes create.
