...
\begin{abstract}
    ...
    In this note, we discuss the three fluid dynamical processes of convective overshoot, entrainment, and convective penetration.
    We describe the structure of a convective boundary which accounts for all of these processes.
